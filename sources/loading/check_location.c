...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/07 12:01:43 by dborione          #+#    #+#             */
/*   Updated: 2024/03/07 12:01:44 by dborione         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_add_player_location_pars(t_game *game, size_t x, size_t y) // a checker, doublon?
{
	if (game->player)
		return (0);
